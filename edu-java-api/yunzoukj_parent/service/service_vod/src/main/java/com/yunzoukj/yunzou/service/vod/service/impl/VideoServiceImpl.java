package com.yunzoukj.yunzou.service.vod.service.impl;
...
import com.yunzoukj.yunzou.service.vod.service.VideoService;
import com.yunzoukj.yunzou.service.vod.util.AliyunVodSDKUtils;
import com.yunzoukj.yunzou.service.vod.util.VodProperties;
    ...
    public void removeVideoByIdList(List<String> videoIdList) throws ClientException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if(i == size -1 || i % 20 == 19){
                ...
                log.error("idListStr = " + idListStr.toString());
