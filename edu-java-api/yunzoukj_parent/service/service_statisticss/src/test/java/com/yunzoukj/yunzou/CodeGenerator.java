...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        String moduleName = "statistics"; // 定义模块名
        // 1、创建代码生成器
...
//        gc.setFileOverride(false); //重新生成时文件是否覆盖
        ...
        dsc.setUrl("jdbc:mysql://216.127.184.152:3306/" + prefix + "yunzoukj_" + moduleName + "?serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("Zwq2573424062@qq.com");
